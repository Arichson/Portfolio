    ...
    return (
        ...
        <div className='Projects'>
            ...
            <div className='single_Project'>
                ...
                <div className="description">
                    This project was created so that users can find recipes and save them into their account. This website includes a login with authentication. It was built with React and Express, as well as a third party Api, Spoonacular.
                </div>
                <div className="techs">Technologies used</div>
                <div>
