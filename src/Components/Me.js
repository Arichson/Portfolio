    ...
    return (
        <div className="containAllOfMe">
            <div className="meBox">
                ...
                <div className="links">
                    <a className="linkedIn" href='https://www.linkedin.com/in/arichsonh' target="blank">Linked In</a> <br />
                    <a className="gitHub" href='https://github.com/Arichson?tab=repositories' target="blank">Github</a>
                </div>
            </div>
        </div>
    )
